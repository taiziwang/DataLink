 ...
 */
@Slf4j
@ConditionalOnProperty(name = "datalink.audit-log.log-type", havingValue = "db")
@ConditionalOnClass(JdbcTemplate.class)
public class DbAuditServiceImpl implements IAuditService {
    private static final String INSERT_SQL = " insert into dbase_logger " +
    ...
    @PostConstruct
    public void init() {
        String sql = "CREATE TABLE IF NOT EXISTS `dbase_logger`  (\n" +
