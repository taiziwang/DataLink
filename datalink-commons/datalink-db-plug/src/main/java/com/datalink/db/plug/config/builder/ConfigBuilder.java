package com.datalink.db.plug.config.builder;

import com.baomidou.mybatisplus.annotation.DbType;
import com.baomidou.mybatisplus.core.toolkit.CollectionUtils;
import com.baomidou.mybatisplus.core.toolkit.StringPool;
import com.baomidou.mybatisplus.core.toolkit.StringUtils;
import com.datalink.db.plug.InjectionConfig;
...
public class ConfigBuilder {
    ...
    private void handlerPackage(TemplateConfig template, String outputDir, PackageConfig config) {
        ...
        packageInfo.put(ConstVal.PACKAGE_NAME, config.getParent());
        ...
        packageInfo.put(ConstVal.XML, joinPackage(config.getMapperParent(), config.getXml()));
        ...
        if (null != configPathInfo) {
            ...
            setPathInfo(pathInfo, template.getEntity(getGlobalConfig().isKotlin()), outputDir + ConstVal.JAVA_BUILD_PATH, ConstVal.ENTITY_PATH, ConstVal.ENTITY);
            setPathInfo(pathInfo, template.getDto(), outputDir + ConstVal.JAVA_BUILD_PATH, ConstVal.DTO_PATH, ConstVal.DTO);
            setPathInfo(pathInfo, template.getMapper(), outputDir + ConstVal.JAVA_BUILD_PATH, ConstVal.MAPPER_PATH, ConstVal.MAPPER);
            setPathInfo(pathInfo, template.getXml(), outputDir + ConstVal.RESOURCES_BUILD_PATH, ConstVal.XML_PATH, ConstVal.XML);
        ...
        try {
            ...
            try (
                ...
                while (results.next()) {
                    ...
                    if (strategyConfig.isEntityNotNullEnable()) {
     ...
     * @return 连接后的路径
     */
    private String joinHtmlPath(String parentDir, String packageName) {
        if (StringUtils.isBlank(parentDir)) {
            return packageName;
        }
        ...
        return parentDir + StringPool.SLASH+packageName;
    }
