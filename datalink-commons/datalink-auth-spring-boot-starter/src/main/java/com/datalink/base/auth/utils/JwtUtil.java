package com.datalink.base.auth.utils;

import com.datalink.base.constant.SecurityConstant;
import com.datalink.base.utils.JsonUtil;
import com.datalink.base.utils.RsaUtil;
...
public class JwtUtil {
    ...
    public static RSAPublicKey getPubKeyObj() {
        Resource res = new ClassPathResource(SecurityConstant.RSA_PUBLIC_KEY);
