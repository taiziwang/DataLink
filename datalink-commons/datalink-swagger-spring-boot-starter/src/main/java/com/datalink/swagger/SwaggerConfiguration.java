...
public class SwaggerConfiguration implements BeanFactoryAware {
    ...
    @Bean
    @ConditionalOnMissingBean
    @ConditionalOnProperty(name = "datalink.swagger.enabled", matchIfMissing = true)
    public List<Docket> createRestApi(SwaggerProperties swaggerProperties) {
        ...
        for (String groupName : swaggerProperties.getDocket().keySet()) {
            ...
            List<com.google.common.base.Predicate<String>> basePath = new ArrayList<>(docketInfo.getBasePath().size());
            for (String path : docketInfo.getBasePath()) {
                basePath.add(PathSelectors.ant(path));
            }

            // exclude-path处理
            List<com.google.common.base.Predicate<String>> excludePath = new ArrayList<>(docketInfo.getExcludePath().size());
