package com.datalink.uaa.config;
...
import com.datalink.uaa.openid.OpenIdAuthenticationSecurityConfig;
import com.datalink.uaa.tenant.TenantAuthenticationSecurityConfig;
import com.datalink.uaa.tenant.TenantUsernamePasswordAuthenticationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public TenantUsernamePasswordAuthenticationFilter tenantAuthenticationFilter(AuthenticationManager authenticationManager) {
        ...
        filter.setFilterProcessesUrl(SecurityConstant.OAUTH_LOGIN_PRO_URL);
        filter.setAuthenticationSuccessHandler(authenticationSuccessHandler);
        filter.setAuthenticationFailureHandler(new SimpleUrlAuthenticationFailureHandler(SecurityConstant.LOGIN_FAILURE_PAGE));
        return filter;
    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        if (tenantProperties.getEnable()) {
            ...
            http.formLogin()
                    .loginPage(SecurityConstant.LOGIN_PAGE)
                    .loginProcessingUrl(SecurityConstant.OAUTH_LOGIN_PRO_URL)
