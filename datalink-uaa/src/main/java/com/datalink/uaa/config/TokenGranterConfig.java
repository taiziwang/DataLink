...
import com.datalink.uaa.granter.MobilePwdGranter;
import com.datalink.uaa.granter.OpenIdGranter;
import com.datalink.uaa.granter.PwdImgCodeGranter;
import com.datalink.uaa.service.IValidateCodeService;
import com.datalink.uaa.service.impl.CustomTokenServices;
...
public class TokenGranterConfig {
     ...
     * 是否登录同应用同账号互踢
     */
    @Value("${datalink.uaa.isSingleLogin:false}")
